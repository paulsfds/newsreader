...
#define COCOAPODS_POD_AVAILABLE_MNMBottomPullToRefresh
#define COCOAPODS_VERSION_MAJOR_MNMBottomPullToRefresh 0
#define COCOAPODS_VERSION_MINOR_MNMBottomPullToRefresh 0
#define COCOAPODS_VERSION_PATCH_MNMBottomPullToRefresh 1
